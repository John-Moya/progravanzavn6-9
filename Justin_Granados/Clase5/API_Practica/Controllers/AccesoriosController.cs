...
namespace API_Practica.Controllers
{
    ...
    {
        private readonly API_PracticaContext _context;

        public AccesoriosController(API_PracticaContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Accesorios>> PostAccesorios(Accesorios accesorios)
        {
            ...
            return CreatedAtAction("GetAccesorios", new { id = accesorios.Id }, accesorios);
        }
