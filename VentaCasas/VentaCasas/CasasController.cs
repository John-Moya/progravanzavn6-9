...
using VentaCasas.Data;
using VentaCasas.Models;

namespace VentaCasas
{
    public class CasasController : Controller
    {
        private readonly VentaCasasContext _context;

        public CasasController(VentaCasasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Direccion,Cuartos,Metros,Banos,Precio")] Casa casa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Direccion,Cuartos,Metros,Banos,Precio")] Casa casa)
        {
            if (id != casa.Id)
            {
                return NotFound();
