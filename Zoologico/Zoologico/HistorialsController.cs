...
namespace Zoologico
{
    public class HistorialsController : Controller
    {
        ...
        public HistorialsController(ZoologicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Aves,Mamiferos,Peces,Reptiles")] Historial historial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Aves,Mamiferos,Peces,Reptiles")] Historial historial)
        {
            if (id != historial.Id)
            {
                return NotFound();
